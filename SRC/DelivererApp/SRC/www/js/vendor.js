...
function update_product(url, shop_id, product_id, product_name, product_price, product_description)
{
    ...
    $.ajax({
        url : url,
        method: "post",
        data: {'shop_id': shop_id, 'product_id': product_id, 'product_name' : product_name, 'product_price' : product_price,
...
function delete_product(url, shop_id, id_product)
{
    ...
    $.ajax({
        url : url,
        method: "post",
        data: {'shop_id': shop_id, 'product_id': id_product},
        dataType: "json",
        async: false,
        success: function (data) {
            json = data;
...
function add_product(url, shop_id, product_name, product_price, product_description)
{
    ...
    $.ajax({
        url : url,
        method: "post",
        data: {'shop_id': shop_id, 'product_name' : product_name, 'product_price' : product_price,
            'product_description' : product_description},
        dataType: "json",
        async: false,
        success: function (data) {
