...
(
  ...
  status INT NOT NULL COMMENT '1: After Creation of Transaction, 2: After Shop Confirmation, 3: After Finding Deliverer, 4: After Customer Confirmation , 5: Transaction Finished',
